...
namespace Tanneryd.BulkOperations.EFCore.SQLite.Tests.UnitTests.Delete
{
    [TestClass]
    public class BulkDeleteTests : BulkOperationTestBase
    {
        ...
        public void DeleteNotExistingEntities()
        {
            ...
            using (var db = Factory.CreateDbContext())
            {
                ...
                Assert.AreEqual((object) p3.Id, people[3].Id);
                Assert.AreEqual((object) p4.Id, people[4].Id);
                Assert.AreEqual((object) p5.Id, people[5].Id);
