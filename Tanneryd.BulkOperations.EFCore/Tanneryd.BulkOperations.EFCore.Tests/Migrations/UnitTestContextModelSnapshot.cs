...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.CoachWithDbGeneratedGuidKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.CoachWithUserGeneratedGuidKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Level1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Level2", "Tanneryd.BulkOperations.EFCore.Tests.Level1.Level2#Level2", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<string>("Level2Name")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)")
                                .HasColumnName("Level2Name");

                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Level3", "Tanneryd.BulkOperations.EFCore.Tests.Level1.Level2#Level2.Level3#Level3", b2 =>
                                {
                                    b2.IsRequired();

                                    b2.Property<string>("Level3Name")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(max)")
                                    ...
                                    b2.Property<DateTime>("Updated")
                                        ...
                                        .HasColumnName("Level2_Level3_Updated");
                                });
                        });

                    b.HasKey("Id")
                        .HasName("PK_dbo.Level1");

                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("Id"));

                    b.ToTable("Level1", "dbo");
                });
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.LogItem", b =>
                {
                    ...
                    b.HasDiscriminator<string>("LogType").HasValue("LogItem");
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.PlayerWithDbGeneratedGuidKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.PlayerWithUserGeneratedGuidKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.TeamWithDbGeneratedGuidKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.TeamWithUserGeneratedGuidKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.LogError", b =>
                {
                    b.HasBaseType("Tanneryd.BulkOperations.EFCore.Tests.LogItem");
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.LogWarning", b =>
                {
                    b.HasBaseType("Tanneryd.BulkOperations.EFCore.Tests.LogItem");
            ...
            modelBuilder.Entity("CoachTeamsWithDbGeneratedGuid", b =>
                {
                    b.HasOne("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.CoachWithDbGeneratedGuidKey", null)
                        .WithMany()
                    ...
                    b.HasOne("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.TeamWithDbGeneratedGuidKey", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CoachTeamsWithUserGeneratedGuid", b =>
                {
                    b.HasOne("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.CoachWithUserGeneratedGuidKey", null)
                        .WithMany()
                        .HasForeignKey("CoachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.TeamWithUserGeneratedGuidKey", null)
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.PlayerWithDbGeneratedGuidKey", b =>
                {
                    b.HasOne("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingDbGeneratedGuidKeys.TeamWithDbGeneratedGuidKey", "Team")
                        .WithMany("Players")
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.PlayerWithUserGeneratedGuidKey", b =>
                {
                    b.HasOne("Tanneryd.BulkOperations.EFCore.Tests.Models.DM.Teams.UsingUserGeneratedGuidKeys.TeamWithUserGeneratedGuidKey", "Team")
                        .WithMany("Players")
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
