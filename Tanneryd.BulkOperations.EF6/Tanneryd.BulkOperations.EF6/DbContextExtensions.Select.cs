...
namespace Tanneryd.BulkOperations.EF6
{
    public static partial class DbContextExtensions
    {
        ...
        {
            return BuildKeyJoinCondition(c.TableColumn.Name, c.TableColumn.Nullable, leftAlias, rightAlias);
        }
            ...
            Type dbTableEntityType)
        {
            ...
            if (keyPropertyMappings.Any(m => m.EntityPropertyName.Contains(".")))
            {
                ...
                for (var i = 0; i < fkMapping.ForeignKeyRelations.Length; i++)
                {
                    ...
                    fkFromColumnNames[i] = fromMapping.TableColumn.Name;
                    fkToColumnNames[i] = toMapping.TableColumn.Name;
                }
