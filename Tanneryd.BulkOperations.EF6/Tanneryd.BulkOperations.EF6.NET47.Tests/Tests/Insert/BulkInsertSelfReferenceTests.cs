...
namespace Tanneryd.BulkOperations.EF6.NET47.Tests.Tests.Insert
{
    ...
    public class BulkInsertSelfReferenceTests : BulkOperationTestBase
    {
        ...
        public void AddingEmployeeToCompanyWithoutParentCompanySet()
        {
            ...
            {
                var expectedMessage =
                    @"The ALTER TABLE statement conflicted with the FOREIGN KEY SAME TABLE constraint ""FK_dbo.Company_dbo.Company_ParentCompanyId"". The conflict occurred in database ""Tanneryd.BulkOperations.EF6.NET47.Tests.Models.EF.CompanyContext"", table ""dbo.Company"", column 'Id'.";
